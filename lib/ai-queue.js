...
class AIQueue {
  constructor(options = {}) {
    // Rate limiting
    this.maxRequestsPerMinute = options.maxRPM || 15;
    this.maxRequestsPerDay = options.maxRPD || 900;
    this.requestDelay = (60 * 1000) / this.maxRequestsPerMinute; // ~4000ms for 15 RPM
